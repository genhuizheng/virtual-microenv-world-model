#!/bin/bash
#SBATCH -J Virtual_microenv_batch
#SBATCH -o Virtual_microenv_batch_%j.out
#SBATCH -e Virtual_microenv_batch_%j.err
#SBATCH -p gh
#SBATCH -N 1
#SBATCH -n 1
...
settings=(
  ...
  "mmd_1e6 1e-6 0.0 1.0 0.0"
  "mmd_3e6 3e-6 0.0 1.0 0.0"
  "mmd_1e5 1e-5 0.0 1.0 0.0"
  "mmd_3e5 3e-5 0.0 1.0 0.0"
  "mmd_1e4 1e-4 0.0 1.0 0.0"
  "mmd_3e4 3e-4 0.0 1.0 0.0"
  "mmd_1e3 1e-3 0.0 1.0 0.0"
  "mmd_3e3 3e-3 0.0 1.0 0.0"
  ...
  "drift_03_pair_anchor 0.0 0.0 0.3 0.0"
  "drift_3_pair_anchor 0.0 0.0 3.0 0.0"
  "drift_03_weak_pop 1e-4 1e-3 0.3 0.0"
  "drift_3_weak_pop 1e-4 1e-3 3.0 0.0"
  "drift_03_medium_pop 3e-4 3e-3 0.3 0.0"
  "drift_3_medium_pop 3e-4 3e-3 3.0 0.0"
)

for setting in "${settings[@]}"; do
  read -r tag lambda_mmd lambda_w2 lambda_drift lambda_down <<< "$setting"
  echo "===== 500k Chreode loss screen: ${tag}, fold=${FOLD} ====="
